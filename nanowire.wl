...
wfmajoranamu[a_,\[Mu]_,vz_,mumax_,sigma_,dim_,index_]:=Block[{testp,testn,gamma,test,gamma1,gamma2},testp=Transpose[Sort[Select[Transpose[Eigensystem[Hmu[a,\[Mu],vz,mumax,sigma,dim],-10,Method->{"Arnoldi","Criteria"->"Magnitude","MaxIterations"->\[Infinity]}]],#1[[1]]>0&],#1[[1]]<#2[[1]]&][[1;;3]]];gamma1=Table[gamma=KroneckerProduct[1/2 ConjugateTranspose[{{1,I,0,0},{0,0,1,I},{0,0,1,-I},{-1,I,0,0}}],IdentityMatrix[dim,SparseArray]].testp[[2,i]];Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{1,3}]]],{i,index}];gamma2=Table[gamma=KroneckerProduct[1/2 ConjugateTranspose[{{1,I,0,0},{0,0,1,I},{0,0,1,-I},{-1,I,0,0}}],IdentityMatrix[dim,SparseArray]].testp[[2,i]];Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{2,4}]]],{i,index}];ListLinePlot[Flatten[Transpose[ArrayFlatten[{gamma1,gamma2}]],1],DataRange->{0,(dim a)/100},PlotLabel->"\!\(\*SubscriptBox[\(V\), \(Z\)]\)="<>ToString[vz]<>"(meV)",PlotRange->Full,Frame->True,Filling->Axis,PlotLegends->Placed[SwatchLegend[{"1st \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","1st \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"}],Top],FrameLabel->{"x(\[Mu]m)",""},PlotStyle->{Blue,Cyan,Red,Orange}]]
...
wfmajoranaqd[a_,\[Mu]_,vz_,l0_,\[Mu]m_,dim_,index_]:=Block[{testp,testn,gamma,test,gamma1,gamma2},testp=Transpose[Sort[Select[Transpose[Eigensystem[Hqd[a,\[Mu],.2,vz,5,dim,l0,\[Mu]m],-10,Method->{"Arnoldi","Criteria"->"Magnitude","MaxIterations"->\[Infinity]}]],#1[[1]]>0&],#1[[1]]<#2[[1]]&][[1;;3]]];gamma1=Table[gamma=KroneckerProduct[1/2 ConjugateTranspose[{{1,I,0,0},{0,0,1,I},{0,0,1,-I},{-1,I,0,0}}],IdentityMatrix[dim,SparseArray]].testp[[2,i]];Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{1,3}]]],{i,index}];gamma2=Table[gamma=KroneckerProduct[1/2 ConjugateTranspose[{{1,I,0,0},{0,0,1,I},{0,0,1,-I},{-1,I,0,0}}],IdentityMatrix[dim,SparseArray]].testp[[2,i]];Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{2,4}]]],{i,index}];ListLinePlot[Flatten[Transpose[ArrayFlatten[{gamma1,gamma2}]],1],DataRange->{0,(dim a)/100},PlotLabel->"\!\(\*SubscriptBox[\(V\), \(Z\)]\)="<>ToString[vz]<>"(meV)",PlotRange->Full,Frame->True,Filling->Axis,PlotLegends->Placed[SwatchLegend[{"1st \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","1st \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"}],Top],FrameLabel->{"x(\[Mu]m)",""},PlotStyle->{Blue,Cyan,Red,Orange}]]
...
wfmajoranasemu[a_,\[Mu]_,vz_,mumax_,sigma_,\[Gamma]_,\[Omega]_,Vc_,dim_,index_]:=Block[{testp,testn,g,gamma,test,gamma1,gamma2},g=Table[testp=Sort[Select[Transpose[Eigensystem[Hsemu[a,\[Mu],vz,mumax,sigma,\[Gamma],\[Omega][[i]],Vc,dim],-6,Method->{"Arnoldi","Criteria"->"Magnitude","MaxIterations"->\[Infinity]}]],#1[[1]]>0&],#1[[1]]<#2[[1]]&][[i]];gamma=KroneckerProduct[1/2 ConjugateTranspose[{{1,I,0,0},{0,0,1,I},{0,0,1,-I},{-1,I,0,0}}],IdentityMatrix[dim,SparseArray]].testp[[2]];{Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{1,3}]]],Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{2,4}]]]},{i,index}];gamma1=g[[All,1]];gamma2=g[[All,2]];ListLinePlot[Flatten[Transpose[ArrayFlatten[{gamma1,gamma2}]],1],DataRange->{0,(dim a)/100},PlotLabel->"\!\(\*SubscriptBox[\(V\), \(Z\)]\)="<>ToString[vz]<>"(meV)",PlotRange->Full,Frame->True,Filling->Axis,PlotLegends->Placed[SwatchLegend[{"1st \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","1st \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"}],Top],FrameLabel->{"x(\[Mu]m)",""},PlotStyle->{Blue,Cyan,Red,Orange}]]


Hseqd[a_?NumberQ,\[Mu]0_?NumberQ,V0_?NumberQ,\[Mu]max_,l0_,\[Gamma]_,\[Omega]_,Vc_,dim_?IntegerQ]:=Block[{t=25/a^2,\[Mu]=\[Mu]0,\[Alpha]=5/(2 a),Vz=V0,\[CapitalDelta]=.2,(*\[Mu]list,\[CapitalDelta]list,*)l=l0,\[Sigma]=1},\[CapitalDelta]list=SparseArray[DiagonalMatrix[\[CapitalDelta] UnitStep[Range[dim]-l]]];\[Mu]list=\[Mu]-\[Mu]max Exp[-(Range[dim]^2/(2\[Sigma] l^2))];\[CapitalDelta]=\[CapitalDelta] Sqrt[1-(V0/Vc)^2];KroneckerProduct[PauliMatrix[3],KroneckerProduct[PauliMatrix[0],-t SparseArray[{Band[{1,2}]->1,Band[{2,1}]->1},{dim,dim}]+(2 t) IdentityMatrix[dim,SparseArray]-DiagonalMatrix[SparseArray[\[Mu]list]]]+KroneckerProduct[PauliMatrix[2],I \[Alpha] SparseArray[{Band[{1,2}]->-1,Band[{2,1}]->1},{dim,dim}]]]+KroneckerProduct[PauliMatrix[0],KroneckerProduct[PauliMatrix[3],Vz IdentityMatrix[dim,SparseArray]]]-\[Gamma] Re[KroneckerProduct[IdentityMatrix[4,SparseArray],\[Omega] /Sqrt[\[CapitalDelta]list^2-\[Omega]^2-I/10^9]]+KroneckerProduct[PauliMatrix[1],KroneckerProduct[IdentityMatrix[2],\[CapitalDelta]list/Sqrt[\[CapitalDelta]list^2-\[Omega]^2-I/10^9]]]]]


wfmajoranaseqd[a_,\[Mu]_,vz_,\[Mu]max_,l0_,\[Gamma]_,\[Omega]_,Vc_,dim_,index_]:=Block[{testp,testn,g,gamma,test,gamma1,gamma2},g=Table[testp=Sort[Select[Transpose[Eigensystem[Hseqd[a,\[Mu],vz,\[Mu]max,l0,\[Gamma],\[Omega][[i]],Vc,dim],-10,Method->{"Arnoldi","Criteria"->"Magnitude","MaxIterations"->\[Infinity]}]],#1[[1]]>0&],#1[[1]]<#2[[1]]&][[i]];gamma=KroneckerProduct[1/2 ConjugateTranspose[{{1,I,0,0},{0,0,1,I},{0,0,1,-I},{-1,I,0,0}}],IdentityMatrix[dim,SparseArray]].testp[[2]];{Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{1,3}]]],Total[ArrayReshape[Abs[gamma]^2,{4,dim}][[{2,4}]]]},{i,index}];gamma1=g[[All,1]];gamma2=g[[All,2]];ListLinePlot[Flatten[Transpose[ArrayFlatten[{gamma1,gamma2}]],1],DataRange->{0,(dim a)/100},PlotLabel->"\!\(\*SubscriptBox[\(V\), \(Z\)]\)="<>ToString[vz]<>"(meV)",PlotRange->Full,Frame->True,Filling->Axis,PlotLegends->Placed[SwatchLegend[{"1st \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","1st \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)","2nd \!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"}],Top],FrameLabel->{"x(\[Mu]m)",""},PlotStyle->{Blue,Cyan,Red,Orange}]]
